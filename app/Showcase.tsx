    ...
    <div className="flex min-h-screen flex-col bg-[color:var(--paper)]">
      ...
      <main className="mx-auto grid w-full max-w-[1500px] flex-1 grid-cols-12 gap-6 px-6 py-8 md:px-10">
        ...
        <section className="col-span-12 md:col-span-6">
          <div className="flex items-baseline justify-between">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                aria-controls="source-drawer-panel"
              >
          ...
          {/* Source drawer */}
          <div id="source-drawer-panel" className="source-drawer mt-6" data-open={editorOpen}>
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label htmlFor="snapshot-json-input" className="eyebrow">snapshot.json</label>
                  <button
                    type="button"
                    className="press-btn"
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label htmlFor="overrides-json-input" className="eyebrow">themeOverrides.json</label>
                  <span className="eyebrow">live</span>
                </div>
                <textarea
                  id="overrides-json-input"
                  className="source-pad block w-full h-64"
                  spellCheck={false}
                  value={overridesJson}
